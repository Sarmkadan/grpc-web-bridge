...
/// <summary>
/// Extension methods for <see cref="ServiceRegistryTests"/> to provide additional test utilities
/// </summary>
public static class ServiceRegistryTestsExtensions
{
	/// <summary>
	/// Creates a test <see cref="ServiceRegistry"/> instance for testing
	/// </summary>
	/// <param name="tests">The test instance</param>
	/// <returns>New <see cref="ServiceRegistry"/> instance</returns>
