...
{
    /// <summary>
    /// Source name used for all bridge activities.
    /// </summary>
    public const string Name = "GrpcWebBridge";
    /// <summary>
    /// Current semantic version of the bridge, embedded in every span.
    /// </summary>
    ...
    /// <summary>
    /// Activity name for a gRPC unary call proxied through the bridge.
    /// </summary>
    public const string GrpcCall = "grpc.bridge.call";
    /// <summary>
    /// Activity name for a server-streaming call.
    /// </summary>
    public const string GrpcStream = "grpc.bridge.stream";
    /// <summary>
    /// Activity name for protocol translation (gRPC-Web → gRPC).
    /// </summary>
    public const string ProtocolTranslation = "grpc.bridge.translate";
    /// <summary>
    /// Activity name for authentication token validation.
    /// </summary>
    ...
    /// <summary>
    /// Semantic convention tag: gRPC service name.
    /// </summary>
    public const string TagRpcService = "rpc.service";
    /// <summary>
    /// Semantic convention tag: gRPC method name.
    /// </summary>
    public const string TagRpcMethod = "rpc.method";
    /// <summary>
    /// Semantic convention tag: gRPC system identifier.
    /// </summary>
    public const string TagRpcSystem = "rpc.system";
    /// <summary>
    /// Tag carrying the gRPC status code string (e.g. "OK", "UNAVAILABLE").
    /// </summary>
    public const string TagGrpcStatus = "rpc.grpc.status_code";
    /// <summary>
    /// Tag carrying the bridge instance name for multi-instance deployments.
    /// </summary>
    public const string TagBridgeInstance = "bridge.instance";
    /// <summary>
    /// Tag indicating whether the operation used streaming.
    /// </summary>
