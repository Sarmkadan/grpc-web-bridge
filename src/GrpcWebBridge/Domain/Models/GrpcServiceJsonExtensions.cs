...
/// <summary>
/// Provides System.Text.Json serialization extensions for <see cref="GrpcService"/> instances.
...
public static class GrpcServiceJsonExtensions
{
    private static readonly JsonSerializerOptions _jsonSerializerOptions = new(JsonSerializerDefaults.Web)
    {
        ...
        TypeInfoResolver = new DefaultJsonTypeInfoResolver()
        {
            Modifiers = {
                static typeInfo =>
                {
                    if (typeInfo.Type == typeof(GrpcService))
                    {
    ...
    /// <summary>
    /// Converts a <see cref="GrpcService"/> instance to its JSON representation.
    /// </summary>
